      ...
      <Box>
        <Container maxW={"3xl"}>
          ...
          >
            ...
            >
              Ghumante <br />
              <Text as={"span"} color={"primary"} whiteSpace="nowrap">
                Explore like a local, with us.
              </Text>
            </Heading>
            <Text color={"gray.500"}>
              Get specialized curated recommendations of places, foods,
              activities and hidden popular local gems to any new place you
